...
class Memcache extends Queue{
    ...
    public function __construct(Connector $connector, Array $options){
        parent::__construct($connector, $options);
        $this->client = \GreenTea\Cache\Connector\Memcache::getInstance()->connect($options);
        $this->access = false;
        $this->sleepTime = 1000;
